...
const char		*stub_NameForFunction	( unsigned __int32 function ) { return "func"; }
...
#include "pm_shared.h"
void HUD_SetAmmo(int iAmmoType, int iCount)
{
	if (iAmmoType != -1 && 0 == g_iUser1 && cl_lw && cl_lw->value)
		gWR.SetAmmo(iAmmoType, iCount);
}

void HUD_SetWeaponClip(int iWeapon, int iCount)
{
	if (0 == g_iUser1 && cl_lw && cl_lw->value)
